...
typedef struct Vector2
{
	...
	static float Distance(Vector2 a)
	{
	...
	static Vector2 Normal(Vector2 vector)
	{
...
typedef struct Vector3
{
	...
	static Vector3 MultiplyPairwise(const Vector3& a, const Vector3& b)
	{
		return Vector3(a.x * b.x, a.y * b.y, a.z * b.z);
	}

	///Returns distance from (0, 0, 0) to given Vector3 point
	static float Distance(const Vector3& a)
	{
	...
	void MultiplyPairwise(const Vector3& b)
	{
		*this = MultiplyPairwise(*this, b);
	}
	...
	void Lerp(const Vector3& b, float t)
	{
		*this = Lerp(*this, b, t);
	}
...
typedef struct Matrix
{
	...
	static float Determinat2(float a, float b, float c, float d)
	{
		return a * d - b * c;
	}

	///Returns Determinant of 2x2 Matrix
	static float Determinat2(Vector2 a, Vector2 b)
	{
	...
	{
		return (a.x * Determinat2(b.y, b.z, c.y, c.z) -
...
public:
	...
	Transform(const Vector3& nPos)
	{
		position = nPos;
		rotation = Quaternion();
		scale = Vector3(1, 1, 1);
	}
	Transform(const Vector3& nPos, const Quaternion& nRot)
	{
		position = nPos;
		rotation = nRot;
		scale = Vector3(1, 1, 1);
	}
	Transform(const Vector3& nPos, const Quaternion& nRot, const Vector3& nScale)
	{
		position = nPos;
		rotation = nRot;
		scale = nScale;
